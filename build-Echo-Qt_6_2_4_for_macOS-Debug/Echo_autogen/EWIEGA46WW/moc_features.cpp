/****************************************************************************
** Meta object code from reading C++ file 'features.h'
**
...
#include <memory>
#include "../../../Echo/features.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'features.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_features_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_features_t qt_meta_stringdata_features = {
    {
QT_MOC_LITERAL(0, 8), // "features"
QT_MOC_LITERAL(9, 16), // "on_homeB_clicked"
QT_MOC_LITERAL(26, 0), // ""
QT_MOC_LITERAL(27, 17) // "on_aboutB_clicked"

    },
    "features\0on_homeB_clicked\0\0on_aboutB_clicked"
};
...
void features::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<features *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject features::staticMetaObject = { {
    ...
    qt_meta_stringdata_features.offsetsAndSize,
    qt_meta_data_features,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_features_t
, QtPrivate::TypeAndForceComplete<features, std::true_type>
