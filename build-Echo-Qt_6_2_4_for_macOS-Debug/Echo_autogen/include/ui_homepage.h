...
public:
    ...
    void setupUi(QMainWindow *homepage)
    {
        ...
        gridLayoutWidget_2->setGeometry(QRect(330, 300, 631, 291));
        ...
        horizontalLayoutWidget_2->setGeometry(QRect(330, 250, 631, 171));
        ...
        analytics = new QPushButton(horizontalLayoutWidget_2);
